...
export const generateTitleUpdate = async (paperId) =>{
    ...
    Based on this information, what more information should I gather to find examples of Papers and their titles that have very high read counts and citation counts?`;
    ...
    // const finalWebContext = await fetchWebContext(getWebContextPrompt, fileKey);
    // const webRelevant = validateQueryWeb(getWebContextPrompt,finalWebContext);
    ...
    // console.log(text, links);
    const llamaText = await generateTitleLlama(paper_id);
